...
export default function App() {
  ...
  const createSender = async () => {
    ...
    console.log('Sender account: ', newKeyPair.publicKey);
    console.log('Airdropping 2 SOL to Sender Wallet');

    // request airdrop into this new account
    const airdroptx = await connection.requestAirdrop(newKeyPair.publicKey, 2 * LAMPORTS_PER_SOL);
    ...
    console.log('this is the new wallet for the airdrop: ',newKeyPair.publicKey.toString());
